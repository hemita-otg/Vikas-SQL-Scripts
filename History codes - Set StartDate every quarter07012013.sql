...
--Select * into masterclientcwm07012013 from mt2sql00.masterclientcoverage.dbo.masterclientcwm 
--End 
...
where clientid not in (3,12,46,92,95,98,146,147,162,999) and startdate<='07/1/2010'
*/

2) For All history Clients 
Case 1a : For History codes(eg. ***Hist)--Dont Set StartDate for CCChist(Item 19718)
/*
Update M set StartDate='07/01/2007' ,EndDate='06/30/2010' 
...
Update M set EndDate='06/30/2010' 
--select distinct startdate ,enddate 
from mt2sql00.masterclientcoverage.dbo.masterclientcwm M
...
--select distinct startdate ,enddate 
from mt2sql00.masterclientcoverage.dbo.masterclientcwm M
where clientid in (3,12,46,92,95,98,146,147,162,999) and startdate <='07/1/2010'
...
--select distinct startdate ,enddate 
from clientcwmexception x where startdate <='07/1/2010'
*/
