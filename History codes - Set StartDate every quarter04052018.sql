...
--Drop table masterclientcwm01022018

--Select * into masterclientcwm040052018 from mt2sql00.masterclientcoverage.dbo.masterclientcwm 
--End 
...
where clientid not in (3,12,46,92,95,98,146,147,162,999) and startdate<='04/01/2015' and StartDate<>DATEADD(yy, -3, DATEADD(qq, DATEDIFF(qq,0,getdate()), 0))
order by 1
*/
...
/*
Update M set StartDate='04/01/2012' ,EndDate='03/31/2015' 
...
from mt2sql00.masterclientcoverage.dbo.masterclientcwm M
where clientid in (3,12,46,92,95,98,146,147,162,999) and startdate <='04/01/2015'
...
--Drop Table ClientCWMException01022018


/*
--Take backup of ClientCWMException table
select * into ClientCWMException04052018 from ClientCWMException
update x set startdate=DATEADD(yy, -3, DATEADD(qq, DATEDIFF(qq,0,getdate()), 0))
--select  startdate ,enddate ,DATEADD(yy, -3, DATEADD(qq, DATEDIFF(qq,0,getdate()), 0))
from clientcwmexception x where startdate <='04/01/2015' and  startdate<>DATEADD(yy, -3, DATEADD(qq, DATEDIFF(qq,0,getdate()), 0))
*/
