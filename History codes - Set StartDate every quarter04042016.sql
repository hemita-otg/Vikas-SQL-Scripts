...
--Drop table masterclientcwm10052015

--Select * into masterclientcwm04042016 from mt2sql00.masterclientcoverage.dbo.masterclientcwm 
--End 
...
where clientid not in (3,12,46,92,95,98,146,147,162,999) and startdate<='04/01/2013'
order by 1
*/
...
/*
Update M set StartDate='04/01/2010' ,EndDate='03/31/2013' 
...
--select distinct startdate ,enddate ,DATEADD(yy, -3, DATEADD(qq, DATEDIFF(qq,0,getdate()), 0))
from mt2sql00.masterclientcoverage.dbo.masterclientcwm M
where clientid in (3,12,46,92,95,98,146,147,162,999) and startdate <='04/01/2013'
...
--Drop Table ClientCWMException10052015


/*
--Take backup of ClientCWMException table
select * into ClientCWMException04042016 from ClientCWMException
update x set startdate=DATEADD(yy, -3, DATEADD(qq, DATEDIFF(qq,0,getdate()), 0))
--select distinct startdate ,enddate 
from clientcwmexception x where startdate <='04/01/2013'
*/
