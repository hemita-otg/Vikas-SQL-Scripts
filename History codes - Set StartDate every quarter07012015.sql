...
--Select * into masterclientcwm07012015 from mt2sql00.masterclientcoverage.dbo.masterclientcwm 
--End 
...
where clientid not in (3,12,46,92,95,98,146,147,162,999) and startdate<='07/01/2012'
order by 1
*/
...
/*
Update M set StartDate='07/01/2009' ,EndDate='06/30/2012' 
...
--select distinct startdate ,enddate ,DATEADD(yy, -3, DATEADD(qq, DATEDIFF(qq,0,getdate()), 0))
from mt2sql00.masterclientcoverage.dbo.masterclientcwm M
where clientid in (3,12,46,92,95,98,146,147,162,999) and startdate <='07/01/2012'
...
select * into ClientCWMException07012015 from ClientCWMException
--update startdate for ClientCWMException
update x set startdate=DATEADD(yy, -3, DATEADD(qq, DATEDIFF(qq,0,getdate()), 0))
--select distinct startdate ,enddate 
from clientcwmexception x where startdate <='07/01/2012'
*/
...
select count(1) from mt3sql1.fvstaging.dbo.adviewmain--4527955
select count(1) from mt2sql00.masteradviewdata.dbo.adviewmain--4527924
select count(1) from mt2asql01.masteradviewdata.dbo.adviewmain --4527577 
select count(1) from mt4sql00.masterdata.dbo.adviewmain--4528147
