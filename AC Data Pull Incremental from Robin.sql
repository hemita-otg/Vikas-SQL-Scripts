...
WHERE circ_i = @circ_i
AND log_tp_i = 9 --publish
ORDER BY create_dt ASC


--for manufacturer pick
...
select Distinct FlyerID,PageDetailID,getdate() as DT into ACFVLOG..ACFVLOG from ACFV.dbo.TempACFV
...
set @backuploc =  '\\mt7ftp0\FTP\ACtoFV\'
