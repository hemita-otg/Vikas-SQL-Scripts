...
--Select * into masterclientcwm10012012 from mt2sql00.masterclientcoverage.dbo.masterclientcwm 
--End 
...
where clientid not in (3,12,24,29,45,92,95,98,146,147,162,253) and startdate<='10/1/2009'
*/
...
/*
Update M set StartDate='10/1/2006' ,EndDate='9/30/2009' 
...
where Categorycodeid in (500,522,702,758,1490,1491,1492,1493,1494,1495,1496,1503,1747,1911,1933,2245,2381)
*/

Case 1b :
--Update only EndDates for 'ccchist','ccchist50' and 'anhhist' till StartDates for these HistoryCodes codes matches with other History Codes
Update M set EndDate='9/30/2009' 
--select distinct startdate ,enddate 
from mt2sql00.masterclientcoverage.dbo.masterclientcwm M
--where Categorycodeid in (Select [id] from MT2SQL04.SiteControl.dbo.CategoryCode where category in ('ccchist','ccchist50','anhhist'))
where Categorycodeid in (2336,2340,2384)
...
--select * 
from mt2sql00.masterclientcoverage.dbo.masterclientcwm M
where clientid in (3,12,24,29,45,92,95,98,146,147,162,253) and startdate <='10/1/2009'
--and Categorycodeid Not in (Select [id] from MT2SQL04.SiteControl.dbo.CategoryCode where category like '%hist%')
and Categorycodeid Not in (500,522,702,758,1490,1491,1492,1493,1494,1495,1496,1503,1747,1911,1933,2245,2381)
...
from clientcwmexception x where startdate <='10/1/2009'
*/
