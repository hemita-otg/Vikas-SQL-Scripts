...
from mt2sql13.sql13.dbo.acfvemailwebflyerreports a
join FRNational.dbo.FlashCoveragePEP b
on a.retmktid = b.retmktid
where AdDate >= '2017-06-19 00:00:00.000' and [Flash Entry Status] = 'JA Entry' and a.media in ('Circular','Email Promotion','Web Promotion')
Union
--For Coke----
...
on a.retmktid = b.retmktid
where AdDate >= '2017-06-19 00:00:00.000' and a.media in ('Circular','Email Promotion','Web Promotion')
