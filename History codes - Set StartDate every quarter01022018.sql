...
--Drop table masterclientcwm10112017

--Select * into masterclientcwm01022018 from mt2sql00.masterclientcoverage.dbo.masterclientcwm 
--End 
...
where clientid not in (3,12,46,92,95,98,146,147,162,999) and startdate<='01/01/2015' and StartDate<>DATEADD(yy, -3, DATEADD(qq, DATEDIFF(qq,0,getdate()), 0))
order by 1
*/
...
/*
Update M set StartDate='01/01/2012' ,EndDate='12/31/2014' 
...
from mt2sql00.masterclientcoverage.dbo.masterclientcwm M
where clientid in (3,12,46,92,95,98,146,147,162,999) and startdate <='01/01/2015'
...
--Drop Table ClientCWMException10112017


/*
--Take backup of ClientCWMException table
select * into ClientCWMException01022018 from ClientCWMException
update x set startdate=DATEADD(yy, -3, DATEADD(qq, DATEDIFF(qq,0,getdate()), 0))
--select  startdate ,enddate 
from clientcwmexception x where startdate <='01/01/2015' and  startdate<>DATEADD(yy, -3, DATEADD(qq, DATEDIFF(qq,0,getdate()), 0))
*/
