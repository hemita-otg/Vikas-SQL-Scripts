--use acfvincr 
--drop table TempACFVDetailReports_1
--exec sp_rename  'TempACFVDetailReports_1ready','TempACFVDetailReports_1'
--Select*  From SQL03.dbo.MasterTableList where TableType = 'Detail'
...
SET @sql =	'
						...
						Select Pagedetailid Into ACFVINCR.dbo.PDT_Delete From SQL03.dbo.ACFVDetailreports with(nolock) where 1 = 2
					'
		EXEC(@sql)
		
		Update SQL03.dbo.MasterTableList Set isProcessed = 0 where TableType = 'Detail' and MT2_Tablename ='TempACFVDetailReports_1'
		...
		While(@i > 0)
		Begin
				SET @MT2_Detail = (Select Top 1 MT2_Tablename From SQL03.dbo.MasterTableList where TableType = 'Detail' And isProcessed = 0)
				...
				SET @sql = 'Delete a From SQL03.dbo.ACFVMPVOfferType a
				...
				SET @sql = '
							  ...
							  Begin
									...
									Delete A
									From SQL03.dbo.ACFVDetailReports A
									Join #t B with(nolock) on A.pagedetailid = B.pagedetailid

									Insert Into SQL03.dbo.ACFVDetailReports ('+ @columnname +')
				...
				Update SQL03.dbo.MasterTableList Set isProcessed = 1 where TableType = 'Detail' And MT2_Tablename = @MT2_Detail 

				SET @i = (Select Count(1) From SQL03.dbo.MasterTableList where TableType = 'Detail' And isProcessed = 0)
		End