...
--Drop table masterclientcwm07032017

--Select * into masterclientcwm10112017 from mt2sql00.masterclientcoverage.dbo.masterclientcwm 
--End 


select *from mt2sql14.sitecontrol.dbo.categorycode where id = 4816
...
where clientid not in (3,12,46,92,95,98,146,147,162,999) and startdate<='10/01/2014' and StartDate<>DATEADD(yy, -3, DATEADD(qq, DATEDIFF(qq,0,getdate()), 0))
order by 1
*/
...
/*
Update M set StartDate='10/01/2011' ,EndDate='09/30/2014' 
...
from mt2sql00.masterclientcoverage.dbo.masterclientcwm M
where clientid in (3,12,46,92,95,98,146,147,162,999) and startdate <='10/01/2014'
...
--Drop Table ClientCWMException07032017


/*
--Take backup of ClientCWMException table
select * into ClientCWMException10112017 from ClientCWMException
update x set startdate=DATEADD(yy, -3, DATEADD(qq, DATEDIFF(qq,0,getdate()), 0))
--select  startdate ,enddate 
from clientcwmexception x where startdate <='10/01/2014' and  startdate<>DATEADD(yy, -3, DATEADD(qq, DATEDIFF(qq,0,getdate()), 0))
*/
