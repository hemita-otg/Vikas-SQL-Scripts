...
--Select * into masterclientcwm04012014 from mt2sql00.masterclientcoverage.dbo.masterclientcwm 
--End 
...
where clientid not in (3,12,46,92,95,98,146,147,162,999) and startdate<='04/01/2011'
*/

2) For All history Clients 
Case 1a : For History codes(eg. ***Hist)--Dont Set StartDate for CCChist(Item 19718)
/*
Update M set StartDate='03/01/2008' ,EndDate='03/31/2011' 
...
/*
Update M set EndDate='12/31/2010' 
--select distinct startdate ,enddate 
from mt2sql00.masterclientcoverage.dbo.masterclientcwm M
...
--select distinct startdate ,enddate 
from mt2sql00.masterclientcoverage.dbo.masterclientcwm M
where clientid in (3,12,46,92,95,98,146,147,162,999) and startdate <='04/01/2011'
...
--select distinct startdate ,enddate 
from clientcwmexception x where startdate <='04/01/2011'
*/
