...
--Select * into masterclientcwm10072016 from mt2sql00.masterclientcoverage.dbo.masterclientcwm 
--End 
...
where clientid not in (3,12,46,92,95,98,146,147,162,999) and startdate<='10/01/2013'
order by 1
*/
...
/*
Update M set StartDate='10/01/2010' ,EndDate='09/30/2013' 
...
--select distinct startdate ,enddate ,DATEADD(yy, -3, DATEADD(qq, DATEDIFF(qq,0,getdate()), 0))
from mt2sql00.masterclientcoverage.dbo.masterclientcwm M
where clientid in (3,12,46,92,95,98,146,147,162,999) and startdate <='10/01/2013'
...
--Drop Table ClientCWMException07012016


/*
--Take backup of ClientCWMException table
select * into ClientCWMException10072016 from ClientCWMException
update x set startdate=DATEADD(yy, -3, DATEADD(qq, DATEDIFF(qq,0,getdate()), 0))
--select distinct startdate ,enddate 
from clientcwmexception x where startdate <='10/01/2013'
*/
