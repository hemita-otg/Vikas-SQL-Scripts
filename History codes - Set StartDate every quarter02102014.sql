...
/*
Update M set StartDate='10/01/2008' ,EndDate='09/30/2011' 
...
5) --build MasterFVHist Package on mt2sql00 - ask hari
6) --restore fvhist db to mt2sql00a and process all fvhist codes(4,5) on mt2sql00a
7) --Run all hist codes for full
8) --backup clienthist db to location \\mt2bu1\MT2BU1D\SQLBU_Archive_Monthly Tape
9)	--going forward when we are doing the End of Quarter changes
