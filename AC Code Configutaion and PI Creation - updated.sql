...
select * into tempdb..usacmpagedetailtable from mt2sql00.entrydata.dbo.usacmcpagedetailtable

select * into tempdb..usacmmultiplepagevalues from mt2sql00.entrydata.dbo.usacmcmultiplepagevalues
--insert for copy tables
...
----------------------------------------------
--first list from masterpdt and 2nd from entrydata expanded
...
--sourcecwm= MasterClientCoverage..EPPRDchildwebmain instead of MasterAdviewData..production
--StartDate: 03/07/2016
Update MT2SQL14.SiteControl.dbo.CategoryCode set ispdt=0,clientpdt=0,cwmfull=null, IsFull=0,sourcecwm= 'MasterClientCoverage..EPPRDChildWebMain'  where category in ('ACFVD')
Update MT2SQL14.SiteControl.dbo.CategoryCode set ispdt=1,clientpdt=1,cwmfull=1, IsFull=1   ,sourcecwm= 'MasterClientCoverage..EPPRDChildWebMain'  where category in ('ACFVD')
--site access to jay , trecia, David Wojdyla
----------------------------------------------
...
--find missing records for parent records skip child records
----------------------------------------------
