...
where clientid not in (3,12,24,29,45,92,95,98,146,147,162,253) and startdate<='7/1/2008'
*/
...
/*
Update M set StartDate='7/1/2005' ,EndDate='6/30/2008' 
from masterclientcoverage.dbo.masterclientcwm M
...
Update M set StartDate=DATEADD(yy, -3, DATEADD(qq, DATEDIFF(qq,0,getdate()), 0))
from masterclientcoverage.dbo.masterclientcwm M
where clientid in (3,12,24,29,45,92,95,98,146,147,162,253) and startdate <='7/1/2008' 
