...
BEGIN
	...
	BEGIN
		...
		begin
			...
			update reportformattemplatesdetail set DisplayName = 'Product Description' Where FieldID = 58
			update reportformattemplatesdetail set DisplayName = 'Offer Description' Where FieldID = 152
			update reportformattemplatesdetail set DisplayName = 'Unit Price - Sale' Where FieldID = 40
			update reportformattemplatesdetail set DisplayName = 'Unit Price - Reg.' Where FieldID = 35
			...
			if exists(select * from reportformattemplatesdetail where fieldid = 56 
				and rpttemplateid = @DTemplateID and displayseq is not null) 
			  and exists(select * from reportformattemplatesdetail where fieldid = 161 
				and rpttemplateid = @DTemplateID and displayseq is null)
			begin
				select @dispseq = DisplaySeq from reportformattemplatesdetail where fieldid = 56 
					and rpttemplateid = @DTemplateID and displayseq is not null
				...
				update 	reportformattemplatesdetail set displayseq = @dispseq + 1 where
				rpttemplateid = @DTemplateID and FieldiD = 161
			end

			if not exists(select * from reportformattemplatesdetail where fieldid = 56 
				and rpttemplateid = @DTemplateID and displayseq is not null) 
			  and exists(select * from reportformattemplatesdetail where fieldid = 161 
				and rpttemplateid = @DTemplateID and displayseq is null)
			begin

				select @dispseq = max(DisplaySeq) from reportformattemplatesdetail where 
					rpttemplateid = @DTemplateID and displayseq is not null
			...
			if exists(select * from reportformattemplatesdetail where fieldid = 160 
				and rpttemplateid = @DTemplateID and displayseq is null) 
			begin
				select @dispseq = DisplaySeq from reportformattemplatesdetail where fieldid = 161 
					and rpttemplateid = @DTemplateID and displayseq is not null
				...
				update 	reportformattemplatesdetail set displayseq = @dispseq + 1 where
				rpttemplateid = @DTemplateID and FieldiD = 160
			end
		end
