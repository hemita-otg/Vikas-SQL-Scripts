...
--Select * into masterclientcwm10052015 from mt2sql00.masterclientcoverage.dbo.masterclientcwm 
--End 
...
where clientid not in (3,12,46,92,95,98,146,147,162,999) and startdate<='10/01/2012'
order by 1
*/
...
/*
Update M set StartDate='10/01/2009' ,EndDate='09/30/2012' 
...
--select distinct startdate ,enddate ,DATEADD(yy, -3, DATEADD(qq, DATEDIFF(qq,0,getdate()), 0))
from mt2sql00.masterclientcoverage.dbo.masterclientcwm M
where clientid in (3,12,46,92,95,98,146,147,162,999) and startdate <='10/01/2012'
...
select * into ClientCWMException10052015 from ClientCWMException
update x set startdate=DATEADD(yy, -3, DATEADD(qq, DATEDIFF(qq,0,getdate()), 0))
--select distinct startdate ,enddate 
from clientcwmexception x where startdate <='10/01/2012'
*/
...
--update mt2sql14.sitecontrol.dbo.tbl_lookup set categoryvalue = 2 where categorytype = 'PercentageDeleteRecord'
