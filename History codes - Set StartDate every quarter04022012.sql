...
where clientid not in (3,12,24,29,45,92,95,98,146,147,162,253) and startdate<='4/1/2010'
*/
...
/*
Update M set StartDate='4/1/2006' ,EndDate='3/31/2009' 
from masterclientcoverage.dbo.masterclientcwm M
...
Update M set StartDate=DATEADD(yy, -3, DATEADD(qq, DATEDIFF(qq,0,getdate()), 0))
from masterclientcoverage.dbo.masterclientcwm M
where clientid in (3,12,24,29,45,92,95,98,146,147,162,253) and startdate <='4/1/2010'
